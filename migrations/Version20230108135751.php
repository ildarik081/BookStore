...
final class Version20230108135751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart_product (id INT NOT NULL, product_id INT DEFAULT NULL, cart_id INT DEFAULT NULL, quantity INT DEFAULT 0 NOT NULL, PRIMARY KEY(id))');
