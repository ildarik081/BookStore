 ...
 */
final class Version20230114055643 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "order" (id SERIAL NOT NULL, status_id INT NOT NULL, session_id VARCHAR(40) NOT NULL, total_price DOUBLE PRECISION DEFAULT \'0\' NOT NULL, email VARCHAR(180) DEFAULT NULL, dt_create TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
